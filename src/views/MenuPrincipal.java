...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desenvolvido por Thiago Gois © 2022");
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				new JOptionPane();
				int painel = JOptionPane.showConfirmDialog(null, "tem certeza que deseja sair?", "Mensagem de confirmação", 1);
				switch(painel) {
					case 0:{
						System.exit(0);
					}
